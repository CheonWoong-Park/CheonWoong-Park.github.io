...
!(function(t, n) {
    ...
    function c(t) {
        for (
            var n = arguments.length, e = Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++
        )
            e[i - 1] = arguments[i];
        return (
            s(e, function(n) {
    ...
    function Z(t, n, e, i, o) {
        ...
        return 0 === n ?
            ...
            e + i :
            (l || (l = 0.3 * o),
                u < ht(i) ? ((u = i), (r = l / 4)) : (r = (l / (2 * dt)) * pt(i / u)), -(u * ct(2, 10 * (n -= 1)) * st(((n * o - r) * (2 * dt)) / l)) + e);
    }
            ...
            return (
                kt(t, [{
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            for (
                                var n = this.options, e = t.target; e && e !== xt; e = e.parentNode
                            )
                                if (v(e, n.trigger)) {
